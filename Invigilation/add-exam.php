...
if(isset($_POST['submit']))
{
   ...
   $tdate=$_POST['tdate'];
   $etype=$_POST['etype'];
     $q="insert into exam_data(e_name,etype,time,from_date,to_date) values('$exam',$etype,$time,'$fdate','$tdate')";
     $r=mysqli_query($con,$q);
     if($r)
     {
         echo '<script>alert("Examination added succesfully...")</script>';
     }
}
...
<div class="row">
<div class="col-12">
<h5 class="form-title"><span>Add Examination</span></h5>
</div>
<div class="col-12 col-sm-6">
<div class="form-group">
<label>Exam Title </label>
<input type="text" class="form-control" placeholder="Examination title" name="exam" required>
</div>
</div>
<div class="col-12 col-sm-6">
<div class="form-group">
...
<option value="2" class="selected">select</option>
