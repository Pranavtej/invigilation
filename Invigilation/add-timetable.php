...
<div class="container">
                             <div class="card-body pt-0">
																		...
																		<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                                                                            ...
                                                                            while($i<6)
                                                                            {
                                                                                $query = "select one,two,three,four,five,six,seven,eight from time_table where day ='$day[$i]'";
                                                                                ...
                                                                                foreach($data as $val)
                                                                                {
																						...
																						<span class="fw-bolder"><input type="text" name="'.$day[$i].''.$j.'"></span>
																					</td>';  
                                                                                    $j++  ;
                                                                                }
                                                                                $i++;
...
<button name="submittimetable" class="btn btn-primary" type="submit"> ADD Timetable</button>
</form>
<?php
include 'connect.php';
...
foreach ($day as $f)
{
    ...
    $m7=$f.'7';
    $m8=$f.'8';
    $g="insert into time_table (day,tid,one,two,three,four,five,six,seven,eight) values('$f','$tid','{$_POST[$m1]}','{$_POST[$m2]}','{$_POST[$m3]}','{$_POST[$m4]}','{$_POST[$m5]}','{$_POST[$m6]}','{$_POST[$m7]}','{$_POST[$m8]}')";
