...
<div class="container">
                             <div class="card-body pt-0">
																		...
																		<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                                                                            ...
                                                                            while($i<6)
                                                                            {
                                                                                $query = "select one,two,three,four,five,six,seven,eight from time_table where day ='$day[$i]' and tid='{$_POST['time']}'";
                                                                                ...
                                                                                foreach($data as $val)
                                                                                {
																						...
																						<span class="fw-bolder"><input type="text" name="'.$day[$i].''.$j.'" value="'.$val.'"></span>
																					</td>';  
                                                                                    $j++  ;
                                                                                }
                                                                                $i++;
...
<button name="submittimetable" class="btn btn-primary" type="submit"> Update  Timetable</button>
</form>
<?php session_start();
include 'connect.php';
...
foreach ($day as $f)
{
    ...
    $m7=$f.'7';
    $m8=$f.'8';
    $g="REPLACE into time_table (day,tid,one,two,three,four,five,six,seven,eight) values('$f','$tid','{$_POST[$m1]}','{$_POST[$m2]}','{$_POST[$m3]}','{$_POST[$m4]}','{$_POST[$m5]}','{$_POST[$m6]}','{$_POST[$m7]}','{$_POST[$m8]}')";
     $sat=mysqli_query($con,$g);
}
if($sat)
{
    echo'<script>alert("Time Table Updated Successfully")</script>';
   session_destroy();     
}
else
{
    ...
    //  $g="insert into time_table (day,tid,one,two,three,four,five,six,seven,eight) values('$d','$tid','$Mon1','$Mon1','$Mon1','$Mon1','$Mon1','$Mon1','$Mon1','$Mon1')";
    //   $g="insert into time_table (day,tid,one,two,three,four,five,six,seven,eight) values('$d','$tid','{$_POST[$x]}','{$_POST[$x]}','{$_POST[$x]}','{$_POST[$x]}','{$_POST[$x]}','{$_POST[$x]}','{$_POST[$x]}','{$_POST[$x]}')";
    // $sat=mysqli_query($con,$g);
      

      // $g="insert into time_table(day,tid,one,two,three,four,five,six,seven,eight) values('MONDAY','$tid1','$_POST['MONDAY1']','$_POST['MONDAY2']','$_POST['MONDAY3']','$_POST['MONDAY4']','$_POST['MONDAY5']','$_POST['MONDAY6']','$_POST['MONDAY7']','$_POST['MONDAY8']')";
 //echo $tid;
}
