...
//    $fdate=$_POST['fdate'];
//    $tdate=$_POST['tdate'];
     $q="insert into staff(tid,tname) values('$tid','$tname')";
...
<input type="text" class="form-control" placeholder="Staff name" name="tname">
</div>
</div>
<div class="col-12 col-sm-6">
<div class="form-group">
<label>Staff ID </label>
<input type="text" class="form-control" placeholder="Staff Id" name="tid">
</div>
</div>
<div class="col-12 col-sm-6">
<div class="form-group">
...
<div class="col-12">
<button type="submit" name="submit" class="btn btn-primary"> Add satff</button>
</div>
</div>
</form>
</div>
